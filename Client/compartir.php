...
$imagenUrl = "https://tudominio.com/ZombResist/generar_imagen.php?jugador=" . urlencode($jugador) . "&puntos=" . urlencode($puntos);
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <meta property="og:url" content="https://tudominio.com/ZombResist/compartir.php?jugador=<?= urlencode($jugador) ?>&puntos=<?= urlencode($puntos) ?>" />
