...
export function CargarModelos(Mapa, scena, listacolision){
    switch (Mapa) {
        case "ciudad":
            Ciudad(scena,listacolision);
            break;
    
        case "militar":
            Militar(scena, listacolision)
            break;
...
function Ciudad(scene,listacolision){
    //avionC
...
function Militar(scene, listacolision){
